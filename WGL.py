...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN AKUN DULU \x1b[1;91m[\xe2\x98\x86]'
...
def menu():
    ...
    try:
        ...
        try:
            ...
            os.system('clear')
            print '\x1b[1;91m[!] \x1b[1;93mAkun checkpoint kok di pake'
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
        except requests.exceptions.ConnectionError:
